...
<div className="playbook-hero" style={{
  ...
  <div style={{ maxWidth: '1100px', margin: '0 auto' }}>
    ...
    <div style={{ display: 'flex', gap: '0.75rem', flexWrap: 'wrap' }}>
      ...
      <a href="https://github.com/nickjlamb/medical-writing-ai-playbook/releases/latest/download/playbook.pdf" style={{
        display: 'inline-block',
        padding: '0.85rem 1.6rem',
        background: 'transparent',
        color: '#ffffff',
...
(function(){
  function update(){
    fetch('https://api.github.com/repos/nickjlamb/medical-writing-ai-playbook/releases/latest')
      ...
      .then(function(d){
        var pdf = (d.assets || []).find(function(a){ return a.name === 'playbook.pdf'; });
        if (!pdf) return;
        var el = document.getElementById('playbook-downloads');
        if (el) el.textContent = pdf.download_count.toLocaleString();
      })
      .catch(function(){});
  }
