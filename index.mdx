...
<CardGroup cols={2}>
  <Card title="Find evidence" icon="microscope" href="/workflows/find-evidence">
    Search biomedical databases and build a curated evidence set for your project.
  </Card>
  ...
  <Card title="Extract study data" icon="file-text" href="/workflows/extract-study-data">
    Pull endpoints, outcomes, and study details into structured evidence tables.
  </Card>
  ...
  <Card title="Create a slide deck" icon="presentation" href="/workflows/create-medical-slide-deck">
    Structure and draft slides for MSL training, advisory boards, or medical education.
  </Card>
