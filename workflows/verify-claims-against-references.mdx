...
**Complements:** [Zotero](https://www.zotero.org) or [EndNote](https://endnote.com) for managing and organising the reference library. RefCheckr verifies whether claims are supported by cited evidence; Zotero and EndNote store, organise, and cite those references.
