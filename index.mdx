...
These workflows follow the lifecycle of a medical writing project, from finding evidence to delivering compliant content.
...
| **Draft** | [Build an Outline](/workflows/build-content-outline) · [Write a Manuscript](/workflows/write-a-manuscript) · [Regulatory Document](/workflows/draft-regulatory-document) · [Stats to Narrative](/workflows/convert-stats-to-narrative) · [Create a Slide Deck](/workflows/create-medical-slide-deck) |
...
| **Validate** | [Verify Claims](/workflows/verify-claims-against-references) · [Compliance Check](/workflows/check-promotional-compliance) · [Document Consistency](/workflows/check-document-consistency) |
...
*A free resource from [PharmaTools.AI](https://pharmatools.ai) · v2.10*
