...
<CardGroup cols={2}>
  <Card title="Markdown" icon="download" href="/downloads/mlr-ai-review-checklist.md">
    Plain-text checklist with checkboxes. Works in any editor; convert to Word or PDF as needed.
  </Card>
  <Card title="Word (.docx)" icon="file-word" href="/downloads/mlr-ai-review-checklist.docx">
