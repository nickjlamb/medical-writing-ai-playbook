...
- [ ] References were compiled in a standard reference manager, **not** generated or formatted by an AI tool. (Prohibited by JAMA Network as of August 2026; discouraged elsewhere.)
...
- [ ] No clinical images, illustrations, video, or audio were created or manipulated by AI. (Prohibited by JAMA Network as of August 2026 unless part of a disclosed research design.)
- [ ] Any brightness, contrast, or colour adjustment was applied uniformly to the whole image and is described in the figure legend with software name and version.
- [ ] Original unedited images retained and available for editorial review.
...
- [ ] **Prohibited uses checked, not just disclosable ones.** Confirm no AI was used for anything the target journal forbids — commonly references, Opinion/Letters/Comments, and clinical imagery.
- [ ] For Opinion articles, editorials, Letters to the Editor, or online Comments: drafted entirely by the named human authors, with no AI drafting assistance.
- [ ] Disclosure includes tool name, version, manufacturer, dates of use, affected portions, and an explicit statement of author responsibility.
...
| **No prohibited AI uses at the target venue** | [Yes / No] |
