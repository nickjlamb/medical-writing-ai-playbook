...
- Reinforces the playbook principle that AI synthesises multiple inputs while the writer remains responsible for verifying interpretation and source alignment
- Tool ecosystem copy tightened: clearer Claude Cowork positioning, condensed example prompt, and "Where the playbook points to it" relabelled to "Referenced in these workflows" across all 16 tools
