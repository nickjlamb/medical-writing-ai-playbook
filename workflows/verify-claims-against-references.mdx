...
**Complements:** [Perplexity](https://www.perplexity.ai) for quick fact-checking and finding source material to verify against. [Zotero](https://www.zotero.org) or [EndNote](https://endnote.com) for managing and organising the reference library. RefCheckr verifies whether claims are supported by cited evidence; Perplexity can help locate the evidence, and Zotero/EndNote store and organise it.
