...
<Update label="Latest updates" description="Recent additions to the playbook">
  ...
  - **v2.5** — New [Description–Discernment Loop](/principles/description-discernment) principle — briefing AI with rich context, evaluating drafts for voice as well as accuracy, and iterating with specific instructions, adapted from the AI Fluency Framework. Plus a new [Voice and Authenticity Check](/prompts/review-prompts#7-voice-and-authenticity-check) review prompt
...
*A free resource from [PharmaTools.AI](https://pharmatools.ai) · v2.7*
