...
|---|---|---|
| **[ICMJE](https://www.icmje.org/recommendations/)** | AI cannot be listed as an author. Authors must disclose AI use in methods or acknowledgments. Authors retain full responsibility for all content. | Tool name, what it was used for, who reviewed |
