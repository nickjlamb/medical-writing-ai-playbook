...
| **MCP** | Model Context Protocol. An open standard created by Anthropic that lets AI assistants call external tools securely. [PubCrawl](/tools/pubcrawl) is an MCP server. |
