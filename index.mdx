...
| **Draft** | [Build an Outline](/workflows/build-content-outline) · [Write a Manuscript](/workflows/write-a-manuscript) · [Create a Slide Deck](/workflows/create-medical-slide-deck) |
...
| **Validate** | [Verify Claims](/workflows/verify-claims-against-references) · [Compliance Check](/workflows/check-promotional-compliance) |
...
*A free resource from [PharmaTools.AI](https://pharmatools.ai) · v2.9*
