...
**Next steps:** Run [Verify Claims Against References](/workflows/verify-claims-against-references) on the full manuscript. If the manuscript includes any content that could be considered promotional, run [Check Promotional Compliance](/workflows/check-promotional-compliance). Complete [Final Human Review](/workflows/final-human-review) before submission.
