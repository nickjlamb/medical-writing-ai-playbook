...
**Next steps:** Use extracted data to [Extract Key Messages](/workflows/extract-key-messages), build an [Evidence Table or Content Outline](/workflows/build-content-outline), or feed into a [Manuscript](/workflows/write-a-manuscript) or [Slide Deck](/workflows/create-medical-slide-deck).
