...
Medical writers will increasingly be asked "could this be an agent?" by clients, sponsors, and tool vendors. Knowing when the answer is yes — and when it isn't — is now part of the job.
