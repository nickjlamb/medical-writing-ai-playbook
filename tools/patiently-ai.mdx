...
Patiently AI is available as a skill on [ClawHub](https://openclaw.ai), the skills marketplace for [OpenClaw](https://github.com/openclaw/openclaw). If you are building with OpenClaw, you can add it now:
