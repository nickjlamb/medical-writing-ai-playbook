...
<CardGroup cols={2}>
  <Card title="CSV" icon="download" href="/downloads/audit-trail-log.csv">
    Opens in Excel, Google Sheets, or Numbers. Includes example rows.
  </Card>
  <Card title="Excel (.xlsx)" icon="file-excel" href="/downloads/audit-trail-log.xlsx">
    Pre-formatted spreadsheet with dropdowns for Scope and Outcome. *Coming soon.*
  </Card>
</CardGroup>
