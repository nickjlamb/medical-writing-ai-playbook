...
<Info>
**Risk tier: Critical** — This workflow is the final quality gate. The reviewer must be qualified for the content type and risk tier.
</Info>
...
<Steps>
  ...
  <Step title="Check the workflow trail">
    Review which workflows and AI tools were used. This tells you where to focus your verification effort — AI-generated sections need closer scrutiny.
  </Step>
