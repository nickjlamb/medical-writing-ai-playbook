...
![Claude Cowork multi-document workflow](https://cdn.prod.website-files.com/66d49e8555a289120a81ec3e/69de801b8f28796fc55f7ca4_99FchZs5DJe6_iNj1967n_nh0BVLXX.png)
...
**Referenced in these workflows:** [Find Evidence](/workflows/find-evidence), [Extract Study Data](/workflows/extract-study-data), [Extract Key Messages](/workflows/extract-key-messages), [Write a Manuscript](/workflows/write-a-manuscript), [Draft a Regulatory Document](/workflows/draft-regulatory-document), [PubCrawl](/tools/pubcrawl)
...
**Referenced in these workflows:** [Find Evidence](/workflows/find-evidence), [Summarise a Source Paper](/workflows/summarise-source-paper), [Extract Study Data](/workflows/extract-study-data), [Extract Key Messages](/workflows/extract-key-messages), [Write a Manuscript](/workflows/write-a-manuscript), [PubCrawl](/tools/pubcrawl)
...
**Referenced in these workflows:** [Find Evidence](/workflows/find-evidence), [Summarise a Source Paper](/workflows/summarise-source-paper), [Extract Study Data](/workflows/extract-study-data), [Extract Key Messages](/workflows/extract-key-messages), [PubCrawl](/tools/pubcrawl), [RefCheckr](/tools/refcheckr)
...
**Referenced in these workflows:** [Find Evidence](/workflows/find-evidence), [PubCrawl](/tools/pubcrawl)
...
**Referenced in these workflows:** [Find Evidence](/workflows/find-evidence), [Summarise a Source Paper](/workflows/summarise-source-paper), [Verify Claims Against References](/workflows/verify-claims-against-references), [PubCrawl](/tools/pubcrawl)
...
**Referenced in these workflows:** [Find Evidence](/workflows/find-evidence), [Verify Claims Against References](/workflows/verify-claims-against-references), [RefCheckr](/tools/refcheckr)
...
**Referenced in these workflows:** [Write a Manuscript](/workflows/write-a-manuscript), [Draft a Regulatory Document](/workflows/draft-regulatory-document), [Create a Medical Slide Deck](/workflows/create-medical-slide-deck)
...
**Referenced in these workflows:** [Write a Manuscript](/workflows/write-a-manuscript), [Create a Medical Slide Deck](/workflows/create-medical-slide-deck)
...
**Referenced in these workflows:** [Build Content Outline](/workflows/build-content-outline), [Create a Medical Slide Deck](/workflows/create-medical-slide-deck), [Repurpose Content Across Channels](/workflows/repurpose-content-across-channels)

## AI image generation

Generative image tools for **concept** visuals only — illustrative imagery, visual abstracts, slide backgrounds, and social graphics where the picture sets tone or communicates an idea. Not for scientific figures, data visualisations, or regulatory-facing content without full review. See [Generate Concept Visuals](/workflows/generate-concept-visuals) for the workflow, prompting patterns, and reality check.
...
**Referenced in these workflows:** [Generate Concept Visuals](/workflows/generate-concept-visuals), [Create a Medical Slide Deck](/workflows/create-medical-slide-deck), [Repurpose Content Across Channels](/workflows/repurpose-content-across-channels)
...
**Referenced in these workflows:** [Extract Key Messages](/workflows/extract-key-messages)
...
- **AI image generators for scientific figures** — AI image models are not a substitute for [BioRender](#biorender) or a medical illustrator when biological accuracy matters. Only concept-appropriate generative tools are included above.
