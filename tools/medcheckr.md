---
title: "MedCheckr"
description: "Pre-screen medical communications content for promotional compliance signals."
icon: "shield"
---
...
| Workflow | Role |
|---|---|
| [Check promotional compliance](/workflows/check-promotional-compliance) | Primary tool — automated compliance signal detection |
| [Final human review](/workflows/final-human-review) | Supporting tool — compliance layer in final QC |
...
3. **Review flagged items** — Assess each flag in context. Not every flag is an actual issue — some may be appropriate for the content type
...
- **Does not interpret specific national regulations.** Promotional codes vary by market. MedCheckr flags general patterns — market-specific compliance requires specialist review.
...
- **Does not assess the scientific accuracy of claims.** Use [RefCheckr](/tools/refcheckr) for claim verification.
...
**[Try MedCheckr →](https://www.pharmatools.ai/medcheckr-ai)** | Part of the [PharmaTools.AI](https://pharmatools.ai) toolkit for medical writing
