...
- **Anything submitted to a journal as a clinical image or illustration** — as of August 2026, JAMA Network does not permit AI-created or AI-manipulated clinical images, illustrations, video, or audio unless they form part of a formal, disclosed research design. Other journals are moving the same way. Concept visuals for internal use, decks, and briefs are a different matter; check the target journal's policy before anything AI-made goes near a submission. See [Declaring AI Use](/principles/declaring-ai-use).
