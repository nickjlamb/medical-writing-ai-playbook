...
- [Zotero](https://www.zotero.org) / [EndNote](https://endnote.com) — store, organise, and cite references. Use these to manage your reference library; use RefCheckr to verify the claims you make against those references.
- [Elicit](https://elicit.com) — extract and compare findings across papers. Useful when building the evidence base before writing, while RefCheckr is used after writing to verify accuracy.
