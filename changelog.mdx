...
- **AI Failure Modes in Medical Writing** page added to Principles — ten predictable ways AI fails when working with scientific evidence (hallucinated citations, misquoted statistics, wrong arm attribution, endpoint confusion, overstated conclusions, data-claim mismatch, source conflation, population drift, missing limitations, compliance phrasing drift), each with example, why it matters, and how to catch it, plus a summary table
