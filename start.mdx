...
<Tip>
**Prefer to read offline?** [Download the playbook as a PDF](https://playbook-counter.pharmatools.workers.dev/download) — the principles in brief, a one-page card for every workflow, and the checklists, in about 40 pages, rebuilt automatically on each update. Every page of the site, including the prompt patterns and worked examples, is in the [complete reference PDF](https://github.com/nickjlamb/medical-writing-ai-playbook/releases/download/latest/Medical-Writing-AI-Playbook-Complete-Reference.pdf).
</Tip>
