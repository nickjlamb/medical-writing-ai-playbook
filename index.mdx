...
A free, open playbook mapping where AI fits — and where it does not — across medical writing workflows. From source paper summarisation to MLR-ready deliverables.
...
<CardGroup cols={3}>
  ...
  <Card title="20+ Prompts" icon="message-square-code">
...
<CardGroup cols={2}>
  ...
  <Card title="Build a Content Outline" icon="layout" href="/workflows/build-content-outline">
  ...
  <Card title="Verify Claims Against References" icon="search-check" href="/workflows/verify-claims-against-references">
    Systematic claim-to-reference checking before MLR submission. **High risk.**
  </Card>
  <Card title="Check Promotional Compliance" icon="shield-alert" href="/workflows/check-promotional-compliance">
    Pre-MLR screening for compliance signals in promotional content. **High risk.**
  </Card>
...
Different tasks carry different consequences when AI is involved. Four tiers define the AI role and review requirements.
...
| **Critical** | Supporting role only | Full expert review, formal sign-off | Final QC before MLR, client delivery, publication |
...
<CardGroup cols={2}>
  ...
  <Card title="Review and Accountability" icon="clipboard-check" href="/principles/review-and-accountability">
    Sign-off protocols and audit trails within existing QC and MLR workflows.
  </Card>
</CardGroup>
...
Purpose-built tools from [PharmaTools.AI](https://pharmatools.ai) for workflow steps where general-purpose LLMs fall short.

<CardGroup cols={3}>
  <Card title="RefCheckr" icon="search" href="/tools/refcheckr">
    Claim-to-reference verification for pre-MLR QC.
  </Card>
  <Card title="MedCheckr" icon="shield" href="/tools/medcheckr">
    Promotional compliance signal screening before MLR.
  </Card>
...
<CardGroup cols={3}>
  ...
  <Card title="Pharma Teams" icon="flask-conical">
    A framework for evaluating and setting standards for agency AI use.
  </Card>
</CardGroup>

<Card title="Start Here" icon="arrow-right" href="/start">
  Role-based paths with recommended reading order and starting workflows
</Card>
