...
**Next steps:** Use your evidence set to [Summarise a Source Paper](/workflows/summarise-source-paper) or [Extract Study Data](/workflows/extract-study-data), then [Extract Key Messages](/workflows/extract-key-messages) for content development.
