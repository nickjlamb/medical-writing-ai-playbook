...
**Alternatives:** [Claude](https://claude.ai) or [ChatGPT](https://chatgpt.com) for initial message brainstorming from source text. [Elicit](https://elicit.com) for cross-paper evidence synthesis when building messages from multiple sources.
