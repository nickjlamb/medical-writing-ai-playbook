---
title: "PosterLens"
description: "Extract structured data from scientific posters for congress coverage and summarisation."
icon: "image"
---
...
| Workflow | Role |
|---|---|
| [Prepare a congress or poster summary](/workflows/prepare-congress-or-poster-summary) | Primary tool — extracting and structuring poster content |
| [Summarise a source paper](/workflows/summarise-source-paper) | Supporting tool — when the source is a poster rather than a paper |
...
**[Try PosterLens →](https://www.pharmatools.ai/posterlens)** | Part of the [PharmaTools.AI](https://pharmatools.ai) toolkit for medical writing
