...
- **[RefCheckr](/tools/refcheckr)** — Closed-loop AI that verifies claims against cited references, rewrites any that don't match, and re-checks the rewrites for ABPI compliance
...
*Last reviewed: 15 April 2026 · 5 min read*
