...
<Tip>
**Prefer to read offline?** [Download the full playbook as a PDF](https://github.com/nickjlamb/medical-writing-ai-playbook/releases/latest/download/playbook.pdf) — every page, in one file, rebuilt automatically on each update.
</Tip>
