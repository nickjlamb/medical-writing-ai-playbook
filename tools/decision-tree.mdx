...
flowchart TD
    ...
    MW --> MW2[MLR compliance check<br/>→ MedCheckr]
    ...
    MW --> MW7[Tailor text to different<br/>audiences → LLMentor]

    Q2 -->|Sources| Q3{What do you need<br/>to do with them?}
    Q2 -->|Drafting from scratch| Q4{Output type?}

    Q3 -->|Explore & question papers| T1[NotebookLM]
    Q3 -->|Structured extraction & comparison| T2[Elicit]
    Q3 -->|Synthesise & draft across sources| T3[Claude Cowork]
    Q3 -->|Quick research-question framing| T5[Consensus]
    Q3 -->|Citation context/sentiment| T6[Scite.ai]
...
- Exploring and questioning one or many papers → [NotebookLM](/tools/ecosystem#notebooklm)
- Synthesising and drafting across multiple sources → [Claude Cowork](/tools/ecosystem#claude-cowork)
- Structured extraction and comparison across papers → [Elicit](/tools/ecosystem#elicit)
...
- MLR compliance check → [MedCheckr](/tools/medcheckr)
...
- Tailor text to different audiences → [LLMentor](/tools/llmentor)
