...
Not all medical writing tasks carry the same risk when AI is involved. Summarising a paper and interpreting a clinical outcome are both "writing," but the consequences of AI getting it wrong are fundamentally different.

This framework helps writers and teams decide:
- Where AI can assist with relatively low risk
- Where AI output requires more careful review
- Where human expertise must remain the primary authority

It complements the playbook's [Risk Levels](/principles/risk-levels) by focusing on the *type* of AI involvement, not just the review intensity.
...
- [Risk Levels](/principles/risk-levels) — four tiers defining review intensity
