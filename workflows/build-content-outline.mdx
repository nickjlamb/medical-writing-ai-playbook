...
**Next steps:** From your outline, proceed to [Write a Manuscript](/workflows/write-a-manuscript), [Create a Medical Slide Deck](/workflows/create-medical-slide-deck), or [Adapt for Different Audiences](/workflows/adapt-for-different-audiences). Run the completed deliverable through [Final Human Review](/workflows/final-human-review).
