...
<AccordionGroup>
  <Accordion title="Can AI build a PubMed search strategy for me?">
  ...
  <Accordion title="Can AI read full-text papers, or only abstracts?">
  ...
  <Accordion title="Is it safe to use AI to screen abstracts?">
  ...
  <Accordion title="How do I know when my evidence set is complete enough?">
  ...
  <Accordion title="What databases should I search beyond PubMed?">
