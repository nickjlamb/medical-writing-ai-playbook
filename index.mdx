...
"og:title": "Medical Writing AI Playbook"
"og:description": "Free AI workflows for medical writing, from finding evidence to final review. Risk tiers, prompt patterns and review frameworks for med comms and pharma teams."
"twitter:title": "Medical Writing AI Playbook"
"twitter:description": "Free AI workflows for medical writing, from finding evidence to final review. Risk tiers, prompt patterns and review frameworks for med comms and pharma teams."
---

import { DownloadCounter } from '/snippets/download-counter.mdx';
...
<div className="playbook-hero" style={{
  ...
  <div style={{ maxWidth: '1100px', margin: '0 auto' }}>
    ...
    <p style={{
      ...
      You’re expected to use AI. You’re still <strong style={{ color: 'inherit', fontWeight: 700 }}>accountable for every claim</strong>. Here’s how to do both.
    </p>
...
<Update label="Latest updates" description="Recent additions to the playbook">
  - **v2.8** — [Choosing Your Model](/principles/choosing-your-model) gains resource cost as a fourth selection axis alongside cost, quality and latency, with the [AI Water and Energy Footprint Calculator](https://www.pharmatools.ai/water-consumption-calculator) to size it — plus a matching note in [Agentic Workflows](/principles/agentic-workflows) on loops that do not earn their keep, and a rewritten homepage subhead
  - **v2.7** — [AI Regulation in Pharma](/principles/ai-regulation) updated for the EU AI Act's Article 50 transparency obligations coming into force (2 August 2026) and the arrival of provider-side content marking — Claude text watermarking, Google SynthID, C2PA image credentials. Includes why the marking obligation sits on the model provider rather than on you, and why detection is not yet something to rely on in either direction
  - **v2.6** — [Declaring AI Use](/principles/declaring-ai-use) and the [disclosure templates](/templates/disclosure-language) updated for JAMA Network's tightened policy (August 2026): AI-generated references, AI-drafted Opinion articles and Letters, and AI-created clinical images are now prohibited outright, not merely disclosable
...
<CardGroup cols={3}>
  ...
  <Card title="Description & Discernment" icon="arrows-rotate" href="/principles/description-discernment">
...
*A free resource from [PharmaTools.AI](https://pharmatools.ai) · v2.8*
