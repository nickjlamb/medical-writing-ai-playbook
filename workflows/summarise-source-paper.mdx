...
**Alternatives:** [Claude](https://claude.ai) or [ChatGPT](https://chatgpt.com) for general-purpose summarisation. [Elicit](https://elicit.com) for finding and comparing related papers alongside the source.
